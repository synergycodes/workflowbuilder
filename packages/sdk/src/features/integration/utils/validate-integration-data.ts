...
import type { TranslationKey, TranslationParams } from '../../i18n/i18next';
...
export function validateIntegrationData(input?: object | string): IntegrationDataValidation {
  ...
  if (typeof objectToCheck.globalVariables === 'object') {
    validatedIntegrationData.globalVariables = objectToCheck.globalVariables;
  }
