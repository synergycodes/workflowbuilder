import type { UISchema, UISchemaElement } from '../types/uischema';
...
/**
 * Reusable "General Information" UISchema accordion (Title / Status /
 * Description) that every standard node type can plug into its own
 * properties UI without redeclaring the three fields by hand.
 *
 * @category Utilities
 */
