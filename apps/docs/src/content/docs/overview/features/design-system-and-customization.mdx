...
- **UI backgrounds:** `--wb-ds-ui-bg-base`, `--wb-ds-ui-bg-elevated`, `--wb-ds-ui-bg-inset`
- **Text:** `--wb-ds-ui-text-default`, `--wb-ds-ui-text-subtle-default`, `--wb-ds-ui-text-muted-default`
- **Node:** `--wb-ds-canvas-node-bg-primary-default`, `--wb-ds-canvas-node-stroke-default`, `--wb-ds-canvas-node-icon-primary`
- **Buttons:** `--wb-ds-components-button-solid-primary-default`, `--wb-ds-components-button-solid-gray-default`
- **Spacing:** `--wb-ds-space-50`, `--wb-ds-space-100`, ..., `--wb-ds-space-400`
- **Border radius:** `--wb-ds-radius-50`, `--wb-ds-radius-100`, ..., `--wb-ds-radius-300`
- **Shadows:** `--wb-ds-shadow-ui-xs-*`, `--wb-ds-shadow-ui-s-*`, ..., `--wb-ds-shadow-ui-xl-*`

### Component overrides

The hand-authored `--wb-public-*` variables are a separate family for per-component customization. The generated CSS-variable tables on UI Library component pages are the `--wb-public-*` tables.
...
```css
:root {
  --wb-ds-ui-bg-base: #1a1a2e;
  --wb-ds-ui-text-default: #e0e0e0;
  --wb-ds-components-button-solid-primary-default: #4a90d9;
}
```
