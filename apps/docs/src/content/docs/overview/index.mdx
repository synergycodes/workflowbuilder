...
[Open the live demo](https://app.workflowbuilder.io) to try Workflow Builder in your browser. To read and edit the code, open the [runnable starter in StackBlitz](https://stackblitz.com/github/synergycodes/workflowbuilder/tree/feat/MARK-3156-stackblitz-starter-example/examples/workflow-builder-starter?title=Workflow%20Builder%20Starter&file=src%2Fapp.tsx) — a minimal React app that embeds the SDK. For a guided walkthrough, [contact us](https://www.workflowbuilder.io/contact).
